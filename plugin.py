...
class BasePlugin:
    ...
    def refresh_and_act(self):
        ...
        SSCheckFeedbackAPI = DomoticzAPI("type=command&param=getdevices&rid={}".format(self.SS_control_idx))
                    ...
                    if "LevelInt" in device:
                        ...
                        if self.Actual_SS_Level != self.Actual_KP_level:
                            ...
                            for f_idx in self.KP_feedback_idxs:
                                DomoticzAPI( "command&param=switchlight&idx={}&switchcmd=Set%20Level&level={}".format(int(f_idx), self.Actual_SS_Level))
